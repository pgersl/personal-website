...
pm: true
---
- _substantiva_ jsou názvy osob, zvířat, věcí, vlastností a dějů
- ukazujeme na ně pomocí zájmen _ten, ta, to, ti, ty, ta_
- jsou ohebné
- ptáme se na ně pomocí otázky _Kdo? Co?_
...
- lze na ně ukázat jen pomocí zájmen v množném čísle _ti, ty, ta_ 
- -> _brýle, housle, játra_
### Podstatná jména hromadná
- jména označující více věcí téhož druhu, ale mající pouze tvar jednotného čísla
- lze na ně ukázat jen pomocí zájmen v jednotném čísle _ten, ta, to_
- -> _kamení, dobytek, ptactvo_
...
- označují:
    - určitou osobu (_Petr Geršl_)
    - určité zvíře (_Rex_)
    - určitou věc (_Brno_)
    - obyvatele a příslušníka národa (_Brňan, Čech_)
    - podník (_Apple_)
    - umělecké dílo (_Étude no.12_)
    - sváteční dny (_Vánoce_)
- píšeme je s velkým písmenem na záčátku, čímž je odlišuje od osobních jmen
- úlohy vlástních jmen mají i víceslovné názvy (_Česká republika_)
