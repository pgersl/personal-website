...
{{< fig class="note-fig" src="/images/figs/bio3/1.jpg" alt="Knidoblasty nezmara" cap="Knihoblasty nezmara: a) buňka s vymrštěným vláknem (1 - jádro buňky, 2 - knidocil, 3 - ostny, 4 - vymrštěné vlákno); b) bunňka s nevymrštěným vláknem" >}}
...
{{< fig class="note-fig" src="/images/figs/bio3/2.jpg" alt="Stavba nezmara obecného" cap="Stavba nezamara obecného: 1 - ektoderm, 2 - entoderm, 3 - mezoglea, 4 - příjmací a vylučovací otvor, 5 - láčka, 6 - pučící jedinec, 7 - chapadlo, 8 - nožní terč, 9 - vznikající spermatozoidy, 10 - vznikající vajíčko" >}}
...
{{< fig class="note-fig" src="/images/figs/bio3/3.jpg" alt="Rozptýlená nervová soustava nezmara" >}}
...
{{< fig class="note-fig" src="/images/figs/bio3/4.jpg" alt="Schéma kolonie trubýšů" cap="Schéma kolonie trubýšů: 1 - pneumatofor, 2 - plovací zvonce (medúzomy), 3 - krycí destičky, 4 - dyktylozoidi, 5 - gasterozoidi, 6 - gonozoidy" >}}
...
{{< fig class="note-fig" src="/images/figs/bio3/5.jpg" alt="Vývoj skyfomedúzy" cap="Vývoj skyfomedúzy: a) planula, b - d) proměna planuly ve skyfopolypa, e - h) strobilace, ch - i) efyra, j) dospělá medúza" >}}
